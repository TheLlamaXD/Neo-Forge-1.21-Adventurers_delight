...
import net.dongurs.delightfull.item.patterns.ModPatternItems;
import net.dongurs.delightfull.potion.ModPotions;
import net.dongurs.delightfull.util.ModItemProperties;
...
@Mod(AdventurersDelight.MOD_ID)
public class AdventurersDelight {
    // Define mod id in a common place for everything to reference
    public static final String MOD_ID = "delightfull";
    // Directly reference a slf4j logger
    private static final Logger LOGGER = LogUtils.getLogger();


    public static final DeferredRegister.Items MOD_PATTERN_ITEMS = DeferredRegister.createItems(MOD_ID);
    ...
    public AdventurersDelight(IEventBus modEventBus, ModContainer modContainer){
        ...
        MOD_PATTERN_ITEMS.register(modEventBus);


        //BannerPatterns
        ModPatternItems.patterns();
