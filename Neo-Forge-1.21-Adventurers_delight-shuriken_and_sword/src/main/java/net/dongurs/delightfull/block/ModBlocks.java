...
import net.dongurs.delightfull.block.paper_blocks.JapaneseLanternBlock;
import net.dongurs.delightfull.block.paper_blocks.SeethroughtBlock;
import net.dongurs.delightfull.block.water_decor.WaterMossBlock;
...
public class ModBlocks {
    ...
    public static final DeferredBlock<Block> WATER_MOSS = registerBlock("water_moss",
            ()-> new WaterMossBlock(BlockBehaviour.Properties.of()
                    .sound(MOSS)
                    .noCollission()
                    .speedFactor(0.5f)
                    .strength(0.5f,0.1f)
