...
public class SamuraiSpiritAnimations {
        ...
        public static final AnimationDefinition FLYING = AnimationDefinition.Builder.withLength(1.5F).looping()
                .addAnimation("handRight", new AnimationChannel(AnimationChannel.Targets.ROTATION,
                        new Keyframe(0.0F, KeyframeAnimations.degreeVec(24.6657F, 4.2085F, -9.0795F), AnimationChannel.Interpolations.CATMULLROM),
                        new Keyframe(0.375F, KeyframeAnimations.degreeVec(24.9476F, -0.5273F, 1.1312F), AnimationChannel.Interpolations.CATMULLROM),
                        new Keyframe(0.75F, KeyframeAnimations.degreeVec(24.9164F, -2.1109F, 4.5336F), AnimationChannel.Interpolations.CATMULLROM),
                        new Keyframe(1.5F, KeyframeAnimations.degreeVec(24.6657F, 4.2085F, -9.0795F), AnimationChannel.Interpolations.CATMULLROM)
                ))
                .addAnimation("handRight", new AnimationChannel(AnimationChannel.Targets.POSITION,
                        ...
                        new Keyframe(0.375F, KeyframeAnimations.posVec(-0.5F, 0.0F, 4.0F), AnimationChannel.Interpolations.CATMULLROM),
                        new Keyframe(1.0833F, KeyframeAnimations.posVec(0.5F, 0.0F, 4.0F), AnimationChannel.Interpolations.CATMULLROM),
                ...
                .addAnimation("onlyHead", new AnimationChannel(AnimationChannel.Targets.ROTATION,
                        ...
                        new Keyframe(0.75F, KeyframeAnimations.degreeVec(4.85F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
                        new Keyframe(1.0F, KeyframeAnimations.degreeVec(9.8511F, 1.7279F, -9.8511F), AnimationChannel.Interpolations.CATMULLROM),
                ...
                .addAnimation("onlyHead", new AnimationChannel(AnimationChannel.Targets.POSITION,
        ...
        public static final AnimationDefinition IDLE = AnimationDefinition.Builder.withLength(2.0F).looping()
                ...
                .addAnimation("onlyHead", new AnimationChannel(AnimationChannel.Targets.SCALE,
                        new Keyframe(0.0F, KeyframeAnimations.scaleVec(1.0F, 1.0F, 1.0F), AnimationChannel.Interpolations.CATMULLROM),
