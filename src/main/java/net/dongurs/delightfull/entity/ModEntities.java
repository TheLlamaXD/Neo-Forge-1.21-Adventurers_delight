...
public class ModEntities {
    ...
    public static final Supplier<EntityType<KoiEntity>> KOI = ENTITY_TYPES.register("koi", ()-> EntityType.Builder.
            of(KoiEntity:: new, MobCategory.MONSTER).sized(0.7f,0.4f).build("koi"));
